...
public class JpgOperationsPerformed {

    //****************Method for Combining multiple Jpg to Pdf File.*******************
    public static void combineJPGToPDF(String pdfPath, String... inputDirsAndFiles) throws IOException {
